...
namespace Json4CPP::Test
{
  ...
  public:
    ...
    TEST_METHOD(TestValueAdd)
    {
      ...
      Assert::ExpectException<exception>([&] { ValueAdd(array1, boolean1); });
      Assert::ExpectException<exception>([&] { ValueAdd(array1, boolean2); });
      Assert::AreEqual<VALUE>(null, ValueAdd(array1, null));
      Assert::ExpectException<exception>([&] { ValueAdd(array1, number1); });
      Assert::ExpectException<exception>([&] { ValueAdd(array1, number2); });
      Assert::ExpectException<exception>([&] { ValueAdd(array1, object1); });
      Assert::ExpectException<exception>([&] { ValueAdd(array1, object2); });
      Assert::ExpectException<exception>([&] { ValueAdd(array1, string1); });
      Assert::ExpectException<exception>([&] { ValueAdd(array1, string2); });
      Assert::ExpectException<exception>([&] { ValueAdd(array2, array1); });
      Assert::ExpectException<exception>([&] { ValueAdd(array2, array2); });
      Assert::ExpectException<exception>([&] { ValueAdd(array2, boolean1); });
      Assert::ExpectException<exception>([&] { ValueAdd(array2, boolean2); });
      Assert::AreEqual<VALUE>(null, ValueAdd(array2, null));
      Assert::ExpectException<exception>([&] { ValueAdd(array2, number1); });
      Assert::ExpectException<exception>([&] { ValueAdd(array2, number2); });
      Assert::ExpectException<exception>([&] { ValueAdd(array2, object1); });
      Assert::ExpectException<exception>([&] { ValueAdd(array2, object2); });
      Assert::ExpectException<exception>([&] { ValueAdd(array2, string1); });
      Assert::ExpectException<exception>([&] { ValueAdd(array2, string2); });
      Assert::ExpectException<exception>([&] { ValueAdd(boolean1, array1); });
      Assert::ExpectException<exception>([&] { ValueAdd(boolean1, array2); });
      Assert::AreEqual<VALUE>(0.0, ValueAdd(boolean1, boolean1));
      Assert::AreEqual<VALUE>(1.0, ValueAdd(boolean1, boolean2));
      Assert::AreEqual<VALUE>(null, ValueAdd(boolean1, null));
      Assert::AreEqual<VALUE>(0.0, ValueAdd(boolean1, number1));
      Assert::AreEqual<VALUE>(1.0, ValueAdd(boolean1, number2));
      Assert::ExpectException<exception>([&] { ValueAdd(boolean1, object1); });
      Assert::ExpectException<exception>([&] { ValueAdd(boolean1, object2); });
      Assert::ExpectException<exception>([&] { ValueAdd(boolean1, string1); });
      Assert::ExpectException<exception>([&] { ValueAdd(boolean1, string2); });
      Assert::ExpectException<exception>([&] { ValueAdd(boolean2, array1); });
      Assert::ExpectException<exception>([&] { ValueAdd(boolean2, array2); });
      Assert::AreEqual<VALUE>(1.0, ValueAdd(boolean2, boolean1));
      Assert::AreEqual<VALUE>(2.0, ValueAdd(boolean2, boolean2));
      Assert::AreEqual<VALUE>(null, ValueAdd(boolean2, null));
      Assert::AreEqual<VALUE>(1.0, ValueAdd(boolean2, number1));
      Assert::AreEqual<VALUE>(2.0, ValueAdd(boolean2, number2));
      Assert::ExpectException<exception>([&] { ValueAdd(boolean2, object1); });
      Assert::ExpectException<exception>([&] { ValueAdd(boolean2, object2); });
      Assert::ExpectException<exception>([&] { ValueAdd(boolean2, string1); });
      Assert::ExpectException<exception>([&] { ValueAdd(boolean2, string2); });
      Assert::AreEqual<VALUE>(null, ValueAdd(null, array1));
      Assert::AreEqual<VALUE>(null, ValueAdd(null, array2));
      Assert::AreEqual<VALUE>(null, ValueAdd(null, boolean1));
      Assert::AreEqual<VALUE>(null, ValueAdd(null, boolean2));
      Assert::AreEqual<VALUE>(null, ValueAdd(null, null));
      Assert::AreEqual<VALUE>(null, ValueAdd(null, number1));
      Assert::AreEqual<VALUE>(null, ValueAdd(null, number2));
      Assert::AreEqual<VALUE>(null, ValueAdd(null, object1));
      Assert::AreEqual<VALUE>(null, ValueAdd(null, object2));
      Assert::AreEqual<VALUE>(null, ValueAdd(null, string1));
      Assert::AreEqual<VALUE>(null, ValueAdd(null, string2));
      Assert::ExpectException<exception>([&] { ValueAdd(number1, array1); });
      Assert::ExpectException<exception>([&] { ValueAdd(number1, array2); });
      Assert::AreEqual<VALUE>(0.0, ValueAdd(number1, boolean1));
      Assert::AreEqual<VALUE>(1.0, ValueAdd(number1, boolean2));
      Assert::AreEqual<VALUE>(null, ValueAdd(number1, null));
      Assert::AreEqual<VALUE>(0.0, ValueAdd(number1, number1));
      Assert::AreEqual<VALUE>(1.0, ValueAdd(number1, number2));
      Assert::ExpectException<exception>([&] { ValueAdd(number1, object1); });
      Assert::ExpectException<exception>([&] { ValueAdd(number1, object2); });
      Assert::ExpectException<exception>([&] { ValueAdd(number1, string1); });
      Assert::ExpectException<exception>([&] { ValueAdd(number1, string2); });
      Assert::ExpectException<exception>([&] { ValueAdd(number2, array1); });
      Assert::ExpectException<exception>([&] { ValueAdd(number2, array2); });
      Assert::AreEqual<VALUE>(1.0, ValueAdd(number2, boolean1));
      Assert::AreEqual<VALUE>(2.0, ValueAdd(number2, boolean2));
      Assert::AreEqual<VALUE>(null, ValueAdd(number2, null));
      Assert::AreEqual<VALUE>(1.0, ValueAdd(number2, number1));
      Assert::AreEqual<VALUE>(2.0, ValueAdd(number2, number2));
      Assert::ExpectException<exception>([&] { ValueAdd(number2, object1); });
      Assert::ExpectException<exception>([&] { ValueAdd(number2, object2); });
      Assert::ExpectException<exception>([&] { ValueAdd(number2, string1); });
      Assert::ExpectException<exception>([&] { ValueAdd(number2, string2); });
      Assert::ExpectException<exception>([&] { ValueAdd(object1, array1); });
      Assert::ExpectException<exception>([&] { ValueAdd(object1, array2); });
      Assert::ExpectException<exception>([&] { ValueAdd(object1, boolean1); });
      Assert::ExpectException<exception>([&] { ValueAdd(object1, boolean2); });
      Assert::AreEqual<VALUE>(null, ValueAdd(object1, null));
      Assert::ExpectException<exception>([&] { ValueAdd(object1, number1); });
      Assert::ExpectException<exception>([&] { ValueAdd(object1, number2); });
      Assert::ExpectException<exception>([&] { ValueAdd(object1, object1); });
      Assert::ExpectException<exception>([&] { ValueAdd(object1, object2); });
      Assert::ExpectException<exception>([&] { ValueAdd(object1, string1); });
      Assert::ExpectException<exception>([&] { ValueAdd(object1, string2); });
      Assert::ExpectException<exception>([&] { ValueAdd(object2, array1); });
      Assert::ExpectException<exception>([&] { ValueAdd(object2, array2); });
      Assert::ExpectException<exception>([&] { ValueAdd(object2, boolean1); });
      Assert::ExpectException<exception>([&] { ValueAdd(object2, boolean2); });
      Assert::AreEqual<VALUE>(null, ValueAdd(object2, null));
      Assert::ExpectException<exception>([&] { ValueAdd(object2, number1); });
      Assert::ExpectException<exception>([&] { ValueAdd(object2, number2); });
      Assert::ExpectException<exception>([&] { ValueAdd(object2, object1); });
      Assert::ExpectException<exception>([&] { ValueAdd(object2, object2); });
      Assert::ExpectException<exception>([&] { ValueAdd(object2, string1); });
      Assert::ExpectException<exception>([&] { ValueAdd(object2, string2); });
      Assert::ExpectException<exception>([&] { ValueAdd(string1, array1); });
      Assert::ExpectException<exception>([&] { ValueAdd(string1, array2); });
      Assert::ExpectException<exception>([&] { ValueAdd(string1, boolean1); });
      Assert::ExpectException<exception>([&] { ValueAdd(string1, boolean2); });
      Assert::AreEqual<VALUE>(null, ValueAdd(string1, null));
      Assert::ExpectException<exception>([&] { ValueAdd(string1, number1); });
      Assert::ExpectException<exception>([&] { ValueAdd(string1, number2); });
      Assert::ExpectException<exception>([&] { ValueAdd(string1, object1); });
      Assert::ExpectException<exception>([&] { ValueAdd(string1, object2); });
      Assert::AreEqual<VALUE>(L"TestString0TestString0"s, ValueAdd(string1, string1));
      Assert::AreEqual<VALUE>(L"TestString0TestString1"s, ValueAdd(string1, string2));
      Assert::ExpectException<exception>([&] { ValueAdd(string2, array1); });
      Assert::ExpectException<exception>([&] { ValueAdd(string2, array2); });
      Assert::ExpectException<exception>([&] { ValueAdd(string2, boolean1); });
      Assert::ExpectException<exception>([&] { ValueAdd(string2, boolean2); });
      Assert::AreEqual<VALUE>(null, ValueAdd(string2, null));
      Assert::ExpectException<exception>([&] { ValueAdd(string2, number1); });
      Assert::ExpectException<exception>([&] { ValueAdd(string2, number2); });
      Assert::ExpectException<exception>([&] { ValueAdd(string2, object1); });
      Assert::ExpectException<exception>([&] { ValueAdd(string2, object2); });
      Assert::AreEqual<VALUE>(L"TestString1TestString0"s, ValueAdd(string2, string1));
      Assert::AreEqual<VALUE>(L"TestString1TestString1"s, ValueAdd(string2, string2));
    }
    ...
    TEST_METHOD(TestValueAddAssign)
    {
      ...
      VALUE value = array1;
      Assert::ExpectException<exception>([&] { ValueAddAssign(value, array1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueAddAssign(value, array2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueAddAssign(value, boolean1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueAddAssign(value, boolean2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::AreEqual<VALUE>(null, ValueAddAssign(value, null));
      Assert::AreEqual<VALUE>(null, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueAddAssign(value, number1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueAddAssign(value, number2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueAddAssign(value, object1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueAddAssign(value, object2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueAddAssign(value, string1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueAddAssign(value, string2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array2;
      Assert::ExpectException<exception>([&] { ValueAddAssign(value, array1); });
      ...
      Assert::AreEqual<VALUE>(boolean1, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(0.0, ValueAddAssign(value, boolean1));
      Assert::AreEqual<VALUE>(0.0, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(1.0, ValueAddAssign(value, boolean2));
      Assert::AreEqual<VALUE>(1.0, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(null, ValueAddAssign(value, null));
      Assert::AreEqual<VALUE>(null, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(0.0, ValueAddAssign(value, number1));
      Assert::AreEqual<VALUE>(0.0, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(1.0, ValueAddAssign(value, number2));
      Assert::AreEqual<VALUE>(1.0, value);
      value = boolean1;
      Assert::ExpectException<exception>([&] { ValueAddAssign(value, object1); });
      Assert::AreEqual<VALUE>(boolean1, value);
      ...
      Assert::AreEqual<VALUE>(boolean2, value);
      value = boolean2;
      Assert::AreEqual<VALUE>(1.0, ValueAddAssign(value, boolean1));
      Assert::AreEqual<VALUE>(1.0, value);
      value = boolean2;
      Assert::AreEqual<VALUE>(2.0, ValueAddAssign(value, boolean2));
      Assert::AreEqual<VALUE>(2.0, value);
      value = boolean2;
      Assert::AreEqual<VALUE>(null, ValueAddAssign(value, null));
      Assert::AreEqual<VALUE>(null, value);
      value = boolean2;
      Assert::AreEqual<VALUE>(1.0, ValueAddAssign(value, number1));
      Assert::AreEqual<VALUE>(1.0, value);
      value = boolean2;
      Assert::AreEqual<VALUE>(2.0, ValueAddAssign(value, number2));
      Assert::AreEqual<VALUE>(2.0, value);
      value = boolean2;
      Assert::ExpectException<exception>([&] { ValueAddAssign(value, object1); });
      Assert::AreEqual<VALUE>(boolean2, value);
      ...
      Assert::AreEqual<VALUE>(boolean2, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueAddAssign(value, array1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueAddAssign(value, array2));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueAddAssign(value, boolean1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueAddAssign(value, boolean2));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueAddAssign(value, null));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueAddAssign(value, number1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueAddAssign(value, number2));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueAddAssign(value, object1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueAddAssign(value, object2));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueAddAssign(value, string1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueAddAssign(value, string2));
      Assert::AreEqual<VALUE>(null, value);
      value = number1;
      Assert::ExpectException<exception>([&] { ValueAddAssign(value, array1); });
      ...
      Assert::AreEqual<VALUE>(string1, value);
      value = string1;
      Assert::AreEqual<VALUE>(L"TestString0TestString0"s, ValueAddAssign(value, string1));
      Assert::AreEqual<VALUE>(L"TestString0TestString0"s, value);
      value = string1;
      Assert::AreEqual<VALUE>(L"TestString0TestString1"s, ValueAddAssign(value, string2));
      ...
      Assert::AreEqual<VALUE>(string2, value);
      value = string2;
      Assert::AreEqual<VALUE>(L"TestString1TestString0"s, ValueAddAssign(value, string1));
      Assert::AreEqual<VALUE>(L"TestString1TestString0"s, value);
      value = string2;
      Assert::AreEqual<VALUE>(L"TestString1TestString1"s, ValueAddAssign(value, string2));
    ...
    TEST_METHOD(TestValueSubtract)
    {
      ...
      Assert::ExpectException<exception>([&] { ValueSubtract(array1, array1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array1, array2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array1, boolean1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array1, boolean2); });
      Assert::AreEqual<VALUE>(null, ValueSubtract(array1, null));
      Assert::ExpectException<exception>([&] { ValueSubtract(array1, number1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array1, number2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array1, object1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array1, object2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array1, string1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array1, string2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array2, array1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array2, array2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array2, boolean1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array2, boolean2); });
      Assert::AreEqual<VALUE>(null, ValueSubtract(array2, null));
      Assert::ExpectException<exception>([&] { ValueSubtract(array2, number1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array2, number2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array2, object1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array2, object2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array2, string1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(array2, string2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(boolean1, array1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(boolean1, array2); });
      Assert::AreEqual<VALUE>(0.0, ValueSubtract(boolean1, boolean1));
      Assert::AreEqual<VALUE>(-1.0, ValueSubtract(boolean1, boolean2));
      Assert::AreEqual<VALUE>(null, ValueSubtract(boolean1, null));
      Assert::AreEqual<VALUE>(0.0, ValueSubtract(boolean1, number1));
      Assert::AreEqual<VALUE>(-1.0, ValueSubtract(boolean1, number2));
      Assert::ExpectException<exception>([&] { ValueSubtract(boolean1, object1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(boolean1, object2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(boolean1, string1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(boolean1, string2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(boolean2, array1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(boolean2, array2); });
      Assert::AreEqual<VALUE>(1.0, ValueSubtract(boolean2, boolean1));
      Assert::AreEqual<VALUE>(0.0, ValueSubtract(boolean2, boolean2));
      Assert::AreEqual<VALUE>(null, ValueSubtract(boolean2, null));
      Assert::AreEqual<VALUE>(1.0, ValueSubtract(boolean2, number1));
      Assert::AreEqual<VALUE>(0.0, ValueSubtract(boolean2, number2));
      Assert::ExpectException<exception>([&] { ValueSubtract(boolean2, object1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(boolean2, object2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(boolean2, string1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(boolean2, string2); });
      Assert::AreEqual<VALUE>(null, ValueSubtract(null, array1));
      Assert::AreEqual<VALUE>(null, ValueSubtract(null, array2));
      Assert::AreEqual<VALUE>(null, ValueSubtract(null, boolean1));
      Assert::AreEqual<VALUE>(null, ValueSubtract(null, boolean2));
      Assert::AreEqual<VALUE>(null, ValueSubtract(null, null));
      Assert::AreEqual<VALUE>(null, ValueSubtract(null, number1));
      Assert::AreEqual<VALUE>(null, ValueSubtract(null, number2));
      Assert::AreEqual<VALUE>(null, ValueSubtract(null, object1));
      Assert::AreEqual<VALUE>(null, ValueSubtract(null, object2));
      Assert::AreEqual<VALUE>(null, ValueSubtract(null, string1));
      Assert::AreEqual<VALUE>(null, ValueSubtract(null, string2));
      Assert::ExpectException<exception>([&] { ValueSubtract(number1, array1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(number1, array2); });
      Assert::AreEqual<VALUE>(0.0, ValueSubtract(number1, boolean1));
      Assert::AreEqual<VALUE>(-1.0, ValueSubtract(number1, boolean2));
      Assert::AreEqual<VALUE>(null, ValueSubtract(number1, null));
      Assert::AreEqual<VALUE>(0.0, ValueSubtract(number1, number1));
      Assert::AreEqual<VALUE>(-1.0, ValueSubtract(number1, number2));
      Assert::ExpectException<exception>([&] { ValueSubtract(number1, object1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(number1, object2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(number1, string1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(number1, string2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(number2, array1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(number2, array2); });
      Assert::AreEqual<VALUE>(1.0, ValueSubtract(number2, boolean1));
      Assert::AreEqual<VALUE>(0.0, ValueSubtract(number2, boolean2));
      Assert::AreEqual<VALUE>(null, ValueSubtract(number2, null));
      Assert::AreEqual<VALUE>(1.0, ValueSubtract(number2, number1));
      Assert::AreEqual<VALUE>(0.0, ValueSubtract(number2, number2));
      Assert::ExpectException<exception>([&] { ValueSubtract(number2, object1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(number2, object2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(number2, string1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(number2, string2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object1, array1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object1, array2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object1, boolean1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object1, boolean2); });
      Assert::AreEqual<VALUE>(null, ValueSubtract(object1, null));
      Assert::ExpectException<exception>([&] { ValueSubtract(object1, number1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object1, number2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object1, object1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object1, object2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object1, string1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object1, string2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object2, array1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object2, array2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object2, boolean1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object2, boolean2); });
      Assert::AreEqual<VALUE>(null, ValueSubtract(object2, null));
      Assert::ExpectException<exception>([&] { ValueSubtract(object2, number1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object2, number2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object2, object1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object2, object2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object2, string1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(object2, string2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string1, array1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string1, array2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string1, boolean1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string1, boolean2); });
      Assert::AreEqual<VALUE>(null, ValueSubtract(string1, null));
      Assert::ExpectException<exception>([&] { ValueSubtract(string1, number1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string1, number2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string1, object1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string1, object2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string1, string1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string1, string2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string2, array1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string2, array2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string2, boolean1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string2, boolean2); });
      Assert::AreEqual<VALUE>(null, ValueSubtract(string2, null));
      Assert::ExpectException<exception>([&] { ValueSubtract(string2, number1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string2, number2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string2, object1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string2, object2); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string2, string1); });
      Assert::ExpectException<exception>([&] { ValueSubtract(string2, string2); });
    }
    ...
    TEST_METHOD(TestValueSubtractAssign)
    {
      ...
      VALUE value = array1;
      Assert::ExpectException<exception>([&] { ValueSubtractAssign(value, array1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueSubtractAssign(value, array2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueSubtractAssign(value, boolean1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueSubtractAssign(value, boolean2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::AreEqual<VALUE>(null, ValueSubtractAssign(value, null));
      Assert::AreEqual<VALUE>(null, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueSubtractAssign(value, number1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueSubtractAssign(value, number2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueSubtractAssign(value, object1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueSubtractAssign(value, object2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueSubtractAssign(value, string1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueSubtractAssign(value, string2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array2;
      Assert::ExpectException<exception>([&] { ValueSubtractAssign(value, array1); });
      Assert::AreEqual<VALUE>(array2, value);
      ...
      Assert::AreEqual<VALUE>(boolean1, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(0.0, ValueSubtractAssign(value, boolean1));
      Assert::AreEqual<VALUE>(0.0, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(-1.0, ValueSubtractAssign(value, boolean2));
      Assert::AreEqual<VALUE>(-1.0, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(null, ValueSubtractAssign(value, null));
      Assert::AreEqual<VALUE>(null, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(0.0, ValueSubtractAssign(value, number1));
      Assert::AreEqual<VALUE>(0.0, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(-1.0, ValueSubtractAssign(value, number2));
      Assert::AreEqual<VALUE>(-1.0, value);
      value = boolean1;
      Assert::ExpectException<exception>([&] { ValueSubtractAssign(value, object1); });
      Assert::AreEqual<VALUE>(boolean1, value);
      ...
      Assert::AreEqual<VALUE>(boolean2, value);
      value = boolean2;
      Assert::AreEqual<VALUE>(1.0, ValueSubtractAssign(value, boolean1));
      Assert::AreEqual<VALUE>(1.0, value);
      value = boolean2;
      Assert::AreEqual<VALUE>(0.0, ValueSubtractAssign(value, boolean2));
      Assert::AreEqual<VALUE>(0.0, value);
      value = boolean2;
      Assert::AreEqual<VALUE>(null, ValueSubtractAssign(value, null));
      Assert::AreEqual<VALUE>(null, value);
      value = boolean2;
      Assert::AreEqual<VALUE>(1.0, ValueSubtractAssign(value, number1));
      Assert::AreEqual<VALUE>(1.0, value);
      value = boolean2;
      Assert::AreEqual<VALUE>(0.0, ValueSubtractAssign(value, number2));
      Assert::AreEqual<VALUE>(0.0, value);
      value = boolean2;
      Assert::ExpectException<exception>([&] { ValueSubtractAssign(value, object1); });
      Assert::AreEqual<VALUE>(boolean2, value);
      ...
      Assert::AreEqual<VALUE>(boolean2, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueSubtractAssign(value, array1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueSubtractAssign(value, array2));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueSubtractAssign(value, boolean1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueSubtractAssign(value, boolean2));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueSubtractAssign(value, null));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueSubtractAssign(value, number1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueSubtractAssign(value, number2));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueSubtractAssign(value, object1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueSubtractAssign(value, object2));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueSubtractAssign(value, string1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueSubtractAssign(value, string2));
      Assert::AreEqual<VALUE>(null, value);
      value = number1;
      Assert::ExpectException<exception>([&] { ValueSubtractAssign(value, array1); });
      Assert::AreEqual<VALUE>(number1, value);
    ...
    TEST_METHOD(TestValueMultiplyAssign)
    {
      ...
      VALUE value = array1;
      Assert::ExpectException<exception>([&] { ValueMultiplyAssign(value, array1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueMultiplyAssign(value, array2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueMultiplyAssign(value, boolean1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueMultiplyAssign(value, boolean2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::AreEqual<VALUE>(null, ValueMultiplyAssign(value, null));
      Assert::AreEqual<VALUE>(null, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueMultiplyAssign(value, number1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueMultiplyAssign(value, number2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueMultiplyAssign(value, object1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueMultiplyAssign(value, object2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueMultiplyAssign(value, string1); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array1;
      Assert::ExpectException<exception>([&] { ValueMultiplyAssign(value, string2); });
      Assert::AreEqual<VALUE>(array1, value);
      value = array2;
      Assert::ExpectException<exception>([&] { ValueMultiplyAssign(value, array1); });
      Assert::AreEqual<VALUE>(array2, value);
      ...
      Assert::AreEqual<VALUE>(boolean1, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(0.0, ValueMultiplyAssign(value, boolean1));
      Assert::AreEqual<VALUE>(0.0, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(0.0, ValueMultiplyAssign(value, boolean2));
      Assert::AreEqual<VALUE>(0.0, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(null, ValueMultiplyAssign(value, null));
      Assert::AreEqual<VALUE>(null, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(0.0, ValueMultiplyAssign(value, number1));
      Assert::AreEqual<VALUE>(0.0, value);
      value = boolean1;
      Assert::AreEqual<VALUE>(0.0, ValueMultiplyAssign(value, number2));
      Assert::AreEqual<VALUE>(0.0, value);
      value = boolean1;
      Assert::ExpectException<exception>([&] { ValueMultiplyAssign(value, object1); });
      Assert::AreEqual<VALUE>(boolean1, value);
      ...
      Assert::AreEqual<VALUE>(0.0, value);
      value = boolean2;
      Assert::AreEqual<VALUE>(1.0, ValueMultiplyAssign(value, boolean2));
      Assert::AreEqual<VALUE>(1.0, value);
      value = boolean2;
      Assert::AreEqual<VALUE>(null, ValueMultiplyAssign(value, null));
      Assert::AreEqual<VALUE>(null, value);
      ...
      Assert::AreEqual<VALUE>(0.0, value);
      value = boolean2;
      Assert::AreEqual<VALUE>(1.0, ValueMultiplyAssign(value, number2));
      Assert::AreEqual<VALUE>(1.0, value);
      value = boolean2;
      Assert::ExpectException<exception>([&] { ValueMultiplyAssign(value, object1); });
      Assert::AreEqual<VALUE>(boolean2, value);
      ...
      Assert::AreEqual<VALUE>(boolean2, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueMultiplyAssign(value, array1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueMultiplyAssign(value, array2));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueMultiplyAssign(value, boolean1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueMultiplyAssign(value, boolean2));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueMultiplyAssign(value, null));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueMultiplyAssign(value, number1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueMultiplyAssign(value, number2));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueMultiplyAssign(value, object1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueMultiplyAssign(value, object2));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueMultiplyAssign(value, string1));
      Assert::AreEqual<VALUE>(null, value);
      value = null;
      Assert::AreEqual<VALUE>(null, ValueMultiplyAssign(value, string2));
      Assert::AreEqual<VALUE>(null, value);
      value = number1;
      Assert::ExpectException<exception>([&] { ValueMultiplyAssign(value, array1); });
      Assert::AreEqual<VALUE>(number1, value);
